#From http://www.codewars.com/kata/5263c6999e0f40dee200059d
...
def get_pins(observed):
    digits = {'0': ['0', '8'], \
              ...
              '8': ['8', '5', '7', '0', '9'], \
              '9': ['9', '6', '8']}
    nums = [digits[digit] for digit in observed]
    return [''.join([d for d in arr]) for arr in itertools.product(*nums)]
